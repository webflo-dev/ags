...
interface MprisProxy extends Gio.DBusProxy {
...
const PlayerIFace = Utils.loadInterfaceXML("org.mpris.MediaPlayer2.Player")!;
const MprisIFace = Utils.loadInterfaceXML("org.mpris.MediaPlayer2")!;
...
export class MprisPlayer extends Service {
  ...
  constructor(busName: string) {
    ...
    this._updateState();
    Utils.idle(this._updateState.bind(this));
  }
  ...
  private _cacheCoverArt() {
    ...
    Utils.ensureDirectory(MEDIA_CACHE_PATH);
  ...
  readonly playPause = () =>
    this._playerProxy.PlayPauseAsync().catch(console.error);
  ...
  readonly previous = () =>
    this._playerProxy.PreviousAsync().catch(console.error);
